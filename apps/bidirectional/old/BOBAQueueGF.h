...
#ifndef BOBAQueueGF_h
#define BOBAQueueGF_h
...
//				}
	...
	BDOpenClosed<state, BOBAGLowHigh<state>, BOBAFLowHigh<state>> forwardQueue;
	BDOpenClosed<state, BOBAGLowHigh<state>, BOBAFLowHigh<state>> backwardQueue;
private:
	double CLowerBound;
	double GForwardMin;
	double GBackwardMin;
