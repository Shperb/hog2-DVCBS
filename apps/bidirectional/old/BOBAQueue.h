...
//			}
	...
	BDOpenClosed<state, BOBACompareOpenReady<state>, BOBACompareOpenWaiting<state>> forwardQueue;
	BDOpenClosed<state, BOBACompareOpenReady<state>, BOBACompareOpenWaiting<state>> backwardQueue;
private:
	double CLowerBound;
};
